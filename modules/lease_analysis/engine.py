...
class LeaseAnalysisEngine:
    ...
    def run_full_analysis(
        ...
        velocity, gap, seasonality, intrinsic, pricing, summary.
        """
        from .models import (
        ...
        port_gap_d = compute_gap(leases, as_of, window_days=90)  # default: portfolio
        port_gap = port_gap_d.get("PORTFOLIO")
        ...
        season_exec = season_tab.get("exec_date")

        # 7. Intrinsic adjustments — reserved for future hedonic model
        intrinsic = {}

        # 8. Price (using local price_all from models.py)
