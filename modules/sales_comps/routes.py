...
<style>
:root {
  --cap-primary: #3A8FD4; --text-muted: #8b949e; --text-secondary: #c9d1d9; --bg: #0f1419; --surface: #1a1f2e; --border: #2d3548; --text: #e6edf3; --text2: #8b949e; --accent: #3A8FD4; --green: #10B981; --orange: #d29922; --red: #f85149; }
